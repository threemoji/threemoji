...
public class RegistrationIntentService extends IntentService {
    ...
    private void uploadProfile(boolean update) {
        ...
        try {
            ...
            data.putString(getString(R.string.backend_gender_pref_key),
                    prefs.getString(getString(R.string.pref_filter_gender_key), getString(R.string.pref_filter_gender_default)));
